function [SWP,delta_C,delta_L,node_clus,node_path,nodetonode_path] = small_world_propensity_JP(A, varargin)
...
%edited by James Pang, QIMR Berghofer 2020
...
[net_path,nodetonode_path] = avg_path_matrix(1./W);          %path of the network
node_path = nansum(nodetonode_path,2);
...
[net_clus,node_clus] = avg_clus_matrix(W,varargin{1});
...
function [Clus,C] = avg_clus_matrix(W, met)
...
Clus = nanmean(nanmean(C,1),2);
end


function [Len,D] = avg_path_matrix(M)
